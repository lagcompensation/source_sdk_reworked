...
namespace csgo {
	...
	public:
		...
		virtual bool		get_streamp_rogress( int flow, int* received, int* total ) const = 0;
		...
		virtual void		get_packet_response_latency( int flow, int frame_number, int* latency_milliseconds, int* choke ) const = 0;
	...
	public:
		...
		std::uint32_t& last_command_ack( ) {
			return *reinterpret_cast< std::uint32_t* >( reinterpret_cast< std::uintptr_t >( this ) + 0x4CB4 );
		}

		std::uint32_t& last_outgoing_cmd( ) {
			return *reinterpret_cast< std::uint32_t* >( reinterpret_cast< std::uintptr_t >( this ) + 0x4CAC );
		}
	...
	public:
		...
		virtual net_channel_info_t* get_net_channel_info( ) = 0;
		...
		void exec_client_cmd( const char* cmd ) {
			using o_fn = void( __thiscall* )( void*, const char* );
			csgo::get_vfunc< o_fn >( this, 108 )( this, cmd );
		}

		void client_cmd_unrestricted( const char* cmd ) {
			using o_fn = void( __thiscall* )( void*, const char* );
			csgo::get_vfunc< o_fn >( this, 114 )( this, cmd );
		}
